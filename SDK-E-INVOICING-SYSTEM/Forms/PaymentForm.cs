...
public class PaymentForm : Form
{
    ...
    public PaymentForm()
    {
        ...
        btnAdd = MakeButton("➕ Add Payment", "#4CAF50");
        ...
        dgvPayments.ColumnHeadersDefaultCellStyle.BackColor = ColorTranslator.FromHtml("#2E7D32");
        ...
        dgvPayments.DefaultCellStyle.SelectionBackColor = ColorTranslator.FromHtml("#81C784");
